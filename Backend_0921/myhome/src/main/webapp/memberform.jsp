...
<form method = "post" action = "member.jsp">
	...
	<tr>
		<th>전화번호</th>
		<td>
			<input type = "text" size = "4" maxlength="4" name = "tel1"
			id = "tel1">
			-
	...
	<tr>
		<th>주소</th>
		<td>
			<input type = "text" size = "70" maxlength="70" name = "address"
			id = "address">
		</td>
	</tr>
	...
	<tr>
		<th>취미</th>
		<td>
			<!--라디오버튼과 다르게 다중선택이 가능하다.-->
			<input type = "checkbox" name = "hobby" value = "공부" checkerd>공부
